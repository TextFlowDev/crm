export default {
  ...
  // SEO Module
  SET_SEO_KEYWORD_DATA: 'SET_SEO_KEYWORD_DATA',
  SET_SEO_SERP_DATA: 'SET_SEO_SERP_DATA',
  SET_SEO_AI_ANALYSIS: 'SET_SEO_AI_ANALYSIS',
  SET_SEO_DOMAIN_DATA: 'SET_SEO_DOMAIN_DATA',
  SET_SEO_CONTENT_SUGGESTIONS: 'SET_SEO_CONTENT_SUGGESTIONS',
  SET_SEO_UI_FLAG: 'SET_SEO_UI_FLAG',
  ADD_SEO_SEARCH_HISTORY: 'ADD_SEO_SEARCH_HISTORY',
  CLEAR_SEO_DATA: 'CLEAR_SEO_DATA',
};
